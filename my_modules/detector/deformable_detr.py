...
class CustomDeformableDETR(DeformableDETR):
    ...
    def pre_transformer(
        ...
        img_shape_list = [sample.ori_shape for sample in batch_data_samples]  # img_shape to ori_shape
        input_img_h, input_img_w = batch_input_shape
        masks = mlvl_feats[0].new_zeros((batch_size, input_img_h, input_img_w))
